<template>
  <div>
    <div class="rounded" :class="{ 'bg-tc-primary-dark': style === 'success', 'bg-red-700': style === 'danger' }"
      v-if="show && message">
      <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8 mb-3">
        <div class="flex items-center justify-between flex-wrap">
          <div class="w-0 flex-1 flex items-center min-w-0">
            <span class="flex p-2 rounded-lg"
              :class="{ 'bg-tc-primary': style === 'success', 'bg-red-600': style === 'danger' }">
          ...
          <div class="flex-shrink-0 sm:ml-3">
            <button type="button" class="-mr-1 flex p-2 rounded-md focus:outline-none sm:-mr-2 transition"
              :class="{ 'hover:bg-tc-primary focus:bg-tc-primary': style === 'success', 'hover:bg-red-600 focus:bg-red-600': style === 'danger' }"
